...
for directory in ["dataset", "dataset/val/", "dataset/val/images/", "dataset/val/masks/"]:
    os.makedirs(directory, exist_ok=True)

for directory in ["dataset", "dataset/train/", "dataset/train/images/", "dataset/train/masks/"]:
    os.makedirs(directory, exist_ok=True)
