...
for directory in ["raw_data", "raw_data/images/", "raw_data/masks/"]:
...
def process_image(model_path, image_path, output_dir=None, threshold=0.1, save_overlay=False):
    ...
    train_image_path = os.path.join("raw_data","images", f"{base_name}.jpg")
    ...
    train_mask_path = os.path.join("raw_data", "masks", f"{base_name}.jpg.png")
